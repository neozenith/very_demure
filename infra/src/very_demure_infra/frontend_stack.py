...
class VeryDemureMoreSecureFrontEndStack(cdk.Stack):
    def __init__(self, scope: Construct, construct_id: str, domain: str, acm_certificate_arn: str, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)

        certificate = acm.Certificate.from_certificate_arn(self, "StaticSiteCertificate", acm_certificate_arn)
